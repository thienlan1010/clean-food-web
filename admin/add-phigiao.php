...
<body>
     ...
     <div class="d-flex" id="wrapper">
        ...
        <div class="container-fluid px-3">
            ...
            <div class="container">
                <div class="row m-3">
                    <h2 class="mb-3">Thêm phí giao</h2>
                    <form action="index.php?act=add-fee" method="post">
                        <label for="kc_cantren">Khoảng cách từ (km)</label>
                        <input type="number" id="kc_cantren" name="kc-cantren" placeholder="Nhập khoảng cách đến" step="any" required>

                        <label for="kc_canduoi">Đến khoảng cách (km)</label>
                        <input type="number" id="kc_canduoi" name="kc-canduoi" placeholder="Nhập khoảng cách từ" step="any" required>

                        <label for="tl_cantren">Trọng lượng từ (g)</label>
                        <input type="number" id="tl_cantren" name="tl-cantren" placeholder="Nhập trọng lượng đến" step="any" required>

                        <label for="tl_canduoi">Đến trọng lượng (g)</label>
                        <input type="number" id="tl_canduoi" name="tl-canduoi" placeholder="Nhập trọng lượng từ" step="any" required>

                        <label for="phi">Phí giao (VNĐ)</label>
                        <input type="number" id="phi" name="phi" placeholder="Nhập phí giao" step="any" required>

                        <label for="ngay">Ngày áp dụng</label>
                        <input type="date" id="ngay" name="ngay" required>

                        <input type="submit" name="fee" value="Thêm phí giao" name="themphi">
                    </form>
