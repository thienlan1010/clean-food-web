            ...
            <div class="container">
                <div class="row m-3">
                    ...
                    <script>
                     ...
                     <!-- ADD TÀI KHOẢN -NV -->
                     <!-- <a href="index.php?act=add_nv"><button class="add" name="addsp"><i class="fa-solid fa-plus"></i> Thêm nhân viên</button></a> -->
                <?php 
                if(isset($nv) && $nv){
                   echo '<table>
                    <tr>
                    ...
                    echo '<tr class="text-center mb-2">                    
                        ...
                        <td>'.$nv['NV_HOTEN'].'</td>
                        <td>'.$nv['NV_EMAIL'].'</td>
                        <td>'.$nv['NV_SODIENTHOAI'].'</td>
                        <td>'.$nv['NV_DIACHI'].'</td>
                        <td>'.$nv['NV_TRANGTHAI'].'</td>
                        <td>'.$nv['BP_TENBP'].'</td>                                      
                        <td><a class="btn-edit" href="index.php?act=detail-nv&id='.$nv['NV_ID'].'">Chi tiết</a></td>                                           
                    </tr>';
                   }else{
