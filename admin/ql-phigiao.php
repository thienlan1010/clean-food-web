...
<body>
     ...
     <div class="d-flex" id="wrapper">
        ...
        <div class="container-fluid px-3">
            ...
            <div class="container">
                <div class="row m-3">
                    <h2 class="mb-3">Phí giao</h2>

                    <!-- <form class="search-form d-flex" action="index.php?act=search-danhmuc" method="post" onsubmit="return validateSearch()">
                        <input class="form-control me-2 short-search" type="search" name="nhaptim" placeholder="Tìm kiếm danh mục bằng tên..." aria-label="Search">
                    ...
                    <!-- NÚT THÊM DANH MỤC -->
                        ...
                        <div>
                            <a href="index.php?act=add_phigiao" class="btn-add">
                                <i class="fa-solid fa-plus"></i> Thêm phí giao
                            </a>
                        </div>
                      <?php 
                        ...
                        <tr class="text-center">
                                ...
                                foreach ($phi as $pg) {
                                    echo '<tr class="text-center mb-2">
                                            ...
                                            <td><a class="btn-edit" href="index.php?act=update-phigiao&date='.$pg['PG_NGAYAPDUNG'].'&idkc='.$pg['KC_ID'].'&idtl='.$pg['TL_ID'].'"><i class="fa-solid fa-pencil"></i></a></td>                                            
                                            </td>
                                        </tr>';
                                        $i++;
                                }
                                ...
                                <ul class="pagination justify-content-center">
                                    <?php for ($p = 1; $p <= $total_pages; $p++): ?>
                                        <li class="page-item <?= ($p == $page) ? 'active' : '' ?>">
                                            <a class="page-link" href="index.php?act=qlpg&page=<?= $p ?>"><?= $p ?></a>
                                        </li>
                                    <?php endfor; ?>
                                </ul>
                            </nav>
