     ...
     <div class="d-flex" id="wrapper">
        ...
        <div class="container-fluid px-3">
            ...
            <div class="container">
                <div class="row m-3">
                    <h2>Khách hàng</h2>
                     <form class="search-form d-flex" action="index.php?act=search-customer" method="post" onsubmit="return validateSearch()">
                        <input class="form-control me-2 short-search" type="search" name="nhaptim" placeholder="Tìm kiếm khách hàng theo mã..." aria-label="Search">
                ...
                echo'   <table>
                    ...
                    <tr class="text-center mb-2">   
                        ...
                        <td>'.$kh['KH_DIACHI'].'</td>                                    
                        <td>'.$kh['SODON'].'</td>                                    
                        <td><a class="btn-edit" href="index.php?act=detail-kh&id='.$kh['KH_ID'].'">Chi tiết</a></td>                      
                    </tr>           
                   </table>';   
                    }else{
