...
<body>
     ...
     <div class="d-flex" id="wrapper">
        ...
        <div class="container-fluid px-3">
            ...
            <div class="container">
                <div class="row m-3">
                    <h2 class="mb-4">Thêm nhân viên và tài khoản</h2>
                    <form action="index.php?act=add-nhanvien" method="post">
                        <div class="row">
                            <!-- Tài khoản -->
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="password" class="form-control" id="password" name="password" minlength="8" maxlength="8" placeholder="Mật khẩu phải đúng 8 kí tự" required>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="bophan" name="bophan" required>
                                        ...
                                        if (!empty($bophan)) {
                                            foreach ($bophan as $bp) {
                                                echo '<option value="' . $bp['BP_MABP'] . '">' . $bp['BP_TENBP'] . '</option>';
                                            }
                                        }
                                        ?>
                                    </select>
