            ...
            <div class="container">
                <div class="row m-3">
                    <h2 class="mb-3">Cập nhật danh mục</h2>
                       <form action="index.php?act=xuli-up-dm" method="post">
                            <label for="tendm">Tên danh mục</label>
                            <input type="text" name="tendm" value="<?php echo $dm['DM_TENDM']?>">
                            <label for="tendm">Trạng thái</label>
                            <select name="trangthai" class="form-select mb-3" required>
                                <option value="Còn kinh doanh" <?= ($dm['DM_TRANGTHAI'] === 'Còn kinh doanh') ? 'selected' : '' ?>>Còn kinh doanh</option>
                                <option value="Ngừng kinh doanh" <?= ($dm['DM_TRANGTHAI'] === 'Ngừng kinh doanh') ? 'selected' : '' ?>>Ngừng kinh doanh</option>
                            </select>
                            <input type="hidden" name="iddm" value="<?php echo $dm['DM_MADM']?>">
