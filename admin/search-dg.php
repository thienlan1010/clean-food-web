...
<body>
     ...
     <div class="d-flex" id="wrapper">
        ...
        <div class="container-fluid px-3">
            ...
            <div class="container">
                <div class="row m-3">
                    <h2 class="mb-3">ql đánh giá</h2>

                    <form class="search-form d-flex" action="index.php?act=search-danhgia" method="post" onsubmit="return validateSearch()">
                ...
                echo '<table>
                        ...
                        //>1 tức có dl 
                                    ...
                                    echo '<tr class="text-center mb-2">                                                      
                                            <td>'.$danhgia['DGSP_ID'].'</td>
                                            <td>'.$danhgia['KH_HOTEN'].'</td>
                                            <td>'.$danhgia['DH_MADH'].'</td>
                                            <td>'.$danhgia['DGSP_SOSAO'].'</td>
                                            <td><a class="btn-edit" href="index.php?act=detail-dg&id='.$danhgia['DGSP_ID'].'&idkh='.$danhgia['KH_ID'].'">Chi tiết</a>                                            
                                            </td>
                                        </tr>';                                   
