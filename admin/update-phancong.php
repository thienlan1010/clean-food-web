                        ...
                        <tr class="text-center">
                                ...
                                foreach ($dh as $d) {
                                    echo '<tr class="text-center mb-2">
                                     <form method="post" action="index.php?act=luu_phancong_two">
                                            <td>'.$i.'</td>                                        
                                            <td>'.$d['DH_MADH'].'</td>
                                            <td>'.$d['DH_NGAYDAT'].'</td>
                                            <td>'.$d['KH_ID'].'</td>
                                           ...
                                           <td>'.$d['DH_DIACHINHAN'].'</td>
                                            ...
                                            <td>
                                                ...
                                                <select name="nv_giaohang" class="form-select form-select-sm" required>
                                                    <option value="">-- Chọn NV --</option>';
                                                    foreach ($ds_nv as $id => $nv_data) {
                                                        $selected = ($d['NV_ID'] == $id) ? 'selected' : '';
                                                        echo '<option value="'.$id.'" '.$selected.'>'.$nv_data['hoten'].'</option>';
                                                    }
                                            echo '</select>
