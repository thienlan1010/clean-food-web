...
<head>
    ...
    <style>
       ...
       /* Bỏ khoảng trắng quanh navbar */
        ...
        .btn-edit[href*="update-dm"] {
            background-color: #ffc107; /* vàng */
        }

        .btn-edit[href*="xoa-dm"] {
            ...
            <div class="container">
                <div class="row m-3">
                    ...
                    <!-- NÚT THÊM DANH MỤC -->
                        ...
                        <div>
                            <a href="index.php?act=add_danhmuc" class="btn-add">
                    ...
                    <table>
                        ...
                        <?php 
                            if(isset($dm) && (count($dm) > 0)){//>1 tức có dl 
                                $i=1;
                                foreach ($dm as $sp) {
                                    echo '<tr class="text-center mb-2">
                                            ...
                                            <td>'.$sp['DM_MADM'].'</td>
                                            <td>'.$sp['DM_TENDM'].'</td>
                                            <td>'.$sp['DM_TRANGTHAI'].'</td>
                                            <td><a class="btn-edit" href="index.php?act=update-dm&id='.$sp['DM_MADM'].'"><i class="fa-solid fa-pencil"></i></a>                                            
                                            </td>
                                        </tr>';
                                        $i++;
                                }
