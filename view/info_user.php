...
if (isset($info) && !empty($info)) {
    $kh = $info; // Lấy thông tin khách hàng
                ...
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="index.php?act=capnhat">
                            ...
                            <div class="row mb-3">
                                <label for="name" class="col-md-4 col-form-label">Họ tên</label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" id="name" name="name" value="' . htmlspecialchars($kh['KH_HOTEN']) . '" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" id="phone" name="phone" value="' . htmlspecialchars($kh['KH_SODIENTHOAI']) . '" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" id="address" name="address" value="' . htmlspecialchars($kh['KH_DIACHI']) . '" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="email" class="col-md-4 col-form-label">Email</label>
                                <div class="col-md-8">
                                    <input type="email" class="form-control" id="email" name="email" value="' . htmlspecialchars($kh['KH_EMAIL']) . '" required>
                                </div>
                            </div>
                           
                            
                            <input type="hidden" name="user_id" value="' . htmlspecialchars($kh['TK_ID']) . '">
